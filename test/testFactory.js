      ...
      describe('Mint & Burn', () => {
        it('succeeds when receive ether', async () => {
          ...
          await expect(
            ...
            .to.emit(this.fixedPrice, 'Mint')
            .withArgs(this.user1.address, this.rate)
        ...
        it('succeeds when user1 mint (no platform fee)', async () => {
          ...
          await expect(this.fixedPrice.connect(this.creator).withdraw())
            ...
            .withArgs(
              this.creator.address,
              ethers.utils.parseEther(this.rate).toString()
            )
          ...
          await expect(this.fixedPrice.connect(this.creator).withdraw())
            ...
            .withArgs(
              this.creator.address,
              ethers.utils.parseEther((this.rate * 2).toString()).toString()
            )
        })
        ...
        it('succeeds when user mint (with platform fee)', async () => {
          ...
          await expect(this.fixedPrice.connect(this.creator).withdraw())
            ...
            .withArgs(
              ...
              ethers.utils
                .parseEther(
                  (this.rate * 2 * (1 - this.platformRate / 100)).toString()
                )
                .toString()
            )
        })
